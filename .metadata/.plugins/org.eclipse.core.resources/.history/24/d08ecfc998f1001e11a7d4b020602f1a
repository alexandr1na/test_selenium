...
public class gg {
    public static void main(String[] args) throws InterruptedException {
		...
		driverChrome.findElement(By.cssSelector("#firstname")).sendKeys("ANA");
		Thread.sleep(3000);
		driverChrome.findElement(By.xpath("//input[@id='lastname']")).sendKeys("BUSUIOC");
		driverChrome.findElement(By.xpath("//input[@id='email_address']")).sendKeys("busuioc.ana333@gmail.com");
		...
		//driverChrome.findElement(By.xpath("//a[@aria-label='store logo']//img")).click();
...
//		actions.perform();
//		driverChrome.findElement(By.cssSelector("#JGXC4YH")).sendKeys("ANA");
//		Thread.sleep(3000);
